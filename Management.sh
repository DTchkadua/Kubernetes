...
wget https://releases.rancher.com/install-docker/20.10.sh && sh 20.10.sh && sudo apt  install docker.io || sudo systemctl start docker && sudo systemctl enable docker && sudo systemctl status docker
